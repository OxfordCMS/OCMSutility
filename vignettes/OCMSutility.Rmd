...
## top_taxa
This returns the top most represented taxa, based on cumulative relative abundance. For example, giving the taxa that are in the top 80% abundance in any of the samples.

Usage:
Takes in dataframe or matrix of relative abundance, with samples in columns, taxa in wors. Function returns of vector of taxa, listed from most abundance to least abundant. Only includes taxa in the cumulative sum cutoff.
